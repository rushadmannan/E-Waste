...
else
{
  ...
  if(isset($_POST['id']))
  {
    if(!empty($_POST['id']))
    {
     ...
     if($user=$c_id){
       $sql='INSERT INTO employee(id,name,designation,sector,salary,contact,email,c_id) VALUES(:id,:name,:designation,:sector,:salary,:contact,:email,:c_id)';
      ...
      oci_bind_by_name($compiled,':designation',$designation);
      oci_bind_by_name($compiled,':sector',$sector);
...
<body>
  ...
  <main id="main">
    <div>
    <br><br>
    <h2 align='center'>Enter Emoloyee Data: <h2>
    <form class="setInput" method="post">
        <label for="uname">ID</label>
        <input type="text" class="form-control" id="uname" placeholder="Enter Emoloyee ID" name="id" required>
        <label for="uname">Name</label>
        <input type="text" class="form-control" id="uname" placeholder="Enter Emoloyee Name" name="name" required>
        <label for="uname">Designation</label>
        <input type="text" class="form-control" id="uname" placeholder="Enter Designation" name="designation" required>
        <label for="uname">Sector</label>
        <input type="text" class="form-control" id="uname" placeholder="Enter Sector" name="sector" required>
        <label for="uname">Salary</label>
        <input type="number" class="form-control" id="uname" placeholder="Enter Salary" name="salary" required>
        <label for="uname">Contact no</label>
        <input type="text" class="form-control" id="uname" placeholder="Enter Contact no" name="contact" required>
        <label for="uname">E-mail</label>
        <input type="email" class="form-control" id="uname" placeholder="Enter E-mail" name="email" required>
        <label for="uname">C-ID</label>
        <input type="text" class="form-control" id="uname" placeholder="Enter C_ID" name="c_id" required>
